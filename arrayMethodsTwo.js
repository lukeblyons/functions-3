...
// CODE HERE
// make a new array citiesThatEndWithI
//use filter method on cities to get the cities thatt end in 'I'
//console.log new array
const citiesThatEndWithI = cities.filter((city) => {
...
fruits.forEach((fruit) => {
  if(fruit.color === 'red'){
    return console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is an red`); 
  } else if(fruit.color === 'orange'){
    return console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is an orange`); 
  } else {
    return console.log(`The fruit that ends with index ${fruits.indexOf(fruit)} is neither an apple or orange`); 
  }
})
...
/*
The fruit that ends with index 0 is neither an apple or orange
The fruit that ends with index 1 is an orange
The fruit that ends with index 2 is neither an apple or orange
The fruit that ends with index 3 is an red
*/
...
// CODE HERE
totalNumOfFoodWithRice = foods.filter((element) => {
  return element.tags.includes('rice')
}) .reduce((accumulator, element) => {
  return accumulator + element.price
}, 0)
console.log(totalNumOfFoodWithRice)
// THE TOTAL
